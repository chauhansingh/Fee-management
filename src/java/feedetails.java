 ...
 */
@WebServlet(urlPatterns = {"/feedetails"})
public class feedetails extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    {
        try{
                ...
                out.write("<h2>Fee Details For B.Tech & MBA</h2>");
                out.write("<img src='fee.jpg' style='display: block; margin-left: auto; margin-right: auto;' width='750px'>");
